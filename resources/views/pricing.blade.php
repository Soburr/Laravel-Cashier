<x-app-layout>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-black">Subscription Plans</h2>
            <p class="mt-1 text-gray-600 dark:text-black-400">Choose the plan that better fits your needs.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="mt-12 grid sm:grid-cols-1 lg:grid-cols-3 gap-6 lg:items-center">
            ...
            <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
                <h4 class="font-medium text-lg text-gray-800 dark:text-black">Monthly</h4>
                <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black-200">
            ...
            <div class="flex flex-col border-2 border-indigo-600 text-center shadow-xl rounded-xl p-8 dark:border-indigo-700">
                ...
                <h4 class="font-medium text-lg text-gray-800 dark:text-black">Yearly</h4>
                <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black-200">
                    <span class="font-bold text-2xl -me-2">$</span>
                    34.99
                </span>
            ...
            <!-- Card -->
            <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
                <h4 class="font-medium text-lg text-gray-800 dark:text-black">Lifetime</h4>
                <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black-200">
                    <span class="font-bold text-2xl -me-2">$</span>
                    174.99
                </span>
